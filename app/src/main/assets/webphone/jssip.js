...
var JsSIP = (() => {
    ...
    "node_modules/jssip/lib/Exceptions.js"(exports, module) {
      ...
      var ConfigurationError = class extends Error {
        constructor(parameter, value) {
          ...
          this.value = value;
          this.message = !this.value ? "Missing parameter: ".concat(this.parameter) : "Invalid value ".concat(JSON.stringify(this.value), ' for parameter "').concat(this.parameter, '"');
        }
      };
      var InvalidStateError = class extends Error {
        constructor(status) {
          ...
          this.status = status;
          this.message = "Invalid status: ".concat(status);
        }
      };
    ...
    "node_modules/jssip/lib/Transactions.js"(exports, module) {
      ...
      var NonInviteClientTransaction = class extends EventEmitter {
        constructor(ua, transport, request, eventHandlers) {
          ...
          this.id = "z9hG4bK".concat(Math.floor(Math.random() * 1e7));
          this.ua = ua;
        ...
        _checkInDialogRequest(request) {
          if (!this._remote_seqnum) {
            ...
            if (request.method === JsSIP_C.ACK) {
              if (this._incoming_ack_seqnum === null || request.cseq !== this._incoming_ack_seqnum) {
                return false;
              }
            } else {
              request.reply(500);
    ...
    "node_modules/jssip/lib/Subscriber.js"(exports, module) {
      ...
      module.exports = class Subscriber extends EventEmitter {
        ...
        receiveRequest(request) {
          ...
          if (new_state === void 0) {
            logger.warn("Invalid Subscription-State header value: ".concat(subs_state.state));
            request.reply(400);
            this._terminateDialog(C.WRONG_NOTIFY_RECEIVED);
            return;
          }
        ...
        _receiveSubscribeResponse(response) {
          ...
          if (response.status_code >= 200 && response.status_code < 300) {
            ...
            if (!Utils.isDecimal(expires) || expires <= 0) {
              logger.warn("response without Expires header, setting a default value of ".concat(C.DEFAULT_EXPIRES_SEC));
              expires = C.DEFAULT_EXPIRES_SEC;
            }
            if (expires > 0) {
              this._scheduleSubscribe(expires);
        ...
        _scheduleSubscribe(expires) {
          ...
          logger.debug("next SUBSCRIBE will be sent in ".concat(Math.floor(timeout / 1e3), " sec"));
          clearTimeout(this._expires_timer);
    ...
    "node_modules/jssip/lib/Notifier.js"(exports, module) {
      ...
      module.exports = class Notifier extends EventEmitter {
        ...
        constructor(ua, subscribe, contentType, { extraHeaders, allowEvents, pending, defaultExpires }) {
          ...
          this._content_type = contentType;
          this._headers = Utils.cloneArray(extraHeaders);
          this._headers.push("Event: ".concat(eventName));
          this._contact = this._headers.find((header) => header.startsWith("Contact"));
          if (!this._contact) {
            this._contact = "Contact: ".concat(this._ua._contact.toString());
        ...
        notify(body = null) {
          ...
          if (expires <= 0) {
            ...
            this._sendNotify([";expires=".concat(expires)], body);
          }
        }
        /**
        ...
        _terminateDialog(termination_code) {
          ...
          logger.debug('emit "terminated" code='.concat(termination_code));
        ...
        _sendNotify(subsStateParameters, body = null, extraHeaders = null, state = null) {
          ...
          let subsState = "Subscription-State: ".concat(state || this._parseState());
        ...
        _onData(data) {
          ...
          if (data === "\r\n") {
            ...
            try {
              ...
              logger.debug("received binary message failed to be converted into string: ".concat(error));
              return;
            }
            ...
            if (Object.prototype.hasOwnProperty.call(config.settings, parameter)) {
              switch (parameter) {
                ...
                case "registrar_server": {
                  logger.debug("- ".concat(parameter, ": ").concat(this._configuration[parameter]));
                  break;
                }
                case "password":
                case "ha1":
                case "authorization_jwt": {
                  logger.debug("- ".concat(parameter, ": NOT SHOWN"));
                  break;
                }
                default: {
                  logger.debug("- ".concat(parameter, ": ").concat(JSON.stringify(this._configuration[parameter])));
                }
              }
            }
          }
  ...
  var require_JsSIP = __commonJS({
    "node_modules/jssip/lib/JsSIP.js"(exports, module) {
      var pkg = require_package();
